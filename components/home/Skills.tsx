...
function Skills() {
  return (
    <div className="flex flex-col md:flex-row justify-between relative">
      <h4 className="relative text-4xl w-full text-center md:text-left font-bold md:max-w-lg mb-10 md:mr-10 md:mb-0 md:w-max mr-0 ">
        Quelque compétence et
        technologie que j'utilise le plus ...
        <img
